...
window.onload = function(){  //レンダラーを配置して、最初のレンダリング
  container.appendChild(renderer.domElement); //レンダラーをDOM上に設置
  renderer.render(scene, camera); // sceneをcameraで映す（表示）     レンダリング
}
